...
def send_templated_mail(template_name, from_email, recipient_list, context, cc=[], bcc=[], fail_silently=False, connection=None, headers = {}, files=[]):
    ...
    return connection.send(template_name, from_email, recipient_list, context, cc, bcc, fail_silently, headers=headers, files=files)
